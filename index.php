...
<html lang="en">
<?php
    include "Admin/define/connect.php";
?>
<head>
...
<body class="bg-info-subtle">
              ...
              while($row=mysqli_fetch_assoc($result)){
                ?>
                  <div class="swiper-slide">
                    ...
                    <div class="card position-relative mx-1">
                      <a href="single-product.html"><img src="img/<?php echo $row['img'] ?>" width="300px"  height="300px" class="rounded-4" alt="image"></a>
    ...
    <div class="container my-5 py-5">
      ...
      <div class="isotope-container row">
        <?php
          ...
          while($row=mysqli_fetch_assoc($result)){
            ?>
              <div class="item <?php echo $row['category'] ?> col-md-4 col-lg-3 my-4">
                <div class="z-1 position-absolute rounded-3 m-3 px-3 border border-dark-subtle">
                  Sale
                </div>
                <div class="card position-relative">
                  <a href="single-product.html"><img src="img/<?php echo $row['img'] ?>" width="270px" height="270px" class=" rounded-4" alt="image"></a>
                  <div class="card-body p-0">
                    <a href="single-product.html">
                      <h3 class="card-title pt-4 m-0"><?php echo $row['name'] ?></h3>
                    </a>
  ...
  <section id="insta" class="my-5">
    <div class="row g-0 py-5">
      <?php
        $sql="SELECT img FROM tbl_product WHERE status=1 Limit 0,5";
        $result = mysqli_query($conn,$sql);
        while($row=mysqli_fetch_assoc($result)){
          ?>
            <div class="col instagram-item  text-center position-relative">
              ...
              <a href="#">
                <img src="img/<?php echo $row['img'] ?>" alt="insta-img" width="250px" height="250px" class=" rounded-3">
              </a>
            </div>
          <?php
        }
